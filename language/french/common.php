...
define("_CO_SMLIGHT_ECARD_CLICK_LINK", "Vous avez reçu une carte électronique de la part de %s. Cliquez sur ce lien si vous ne voyez par la carte correctement:<br />
%s");
define("_CO_SMLIGHT_ECARD_POWERED", "Cette carte électronique a été générée par SmartMailLight, une création de INBOX International (<a href='http://inboxinternational.com'>http://inboxinternational.com</a>)");
